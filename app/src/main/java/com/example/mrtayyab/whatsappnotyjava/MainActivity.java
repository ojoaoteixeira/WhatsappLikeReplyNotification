package com.example.mrtayyab.whatsappnotyjava;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String CHANNNEL_ID = "Parho Likho CS";
    public static final String CHANNEL_NAME = "Parho Likho Computer Science";
    public static final String CHANNEL_DESC = "This is a channel for Parho Likho Computer Science Notifications";
    ...
    private void displayNotification() {
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, CHANNNEL_ID)
                    ...
                    .setContentTitle("Hey this is Parho Likho CS...")
